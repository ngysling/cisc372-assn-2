...
//Returns: Nothing
void ompConvolute(Image* srcImage,Image* destImage,Matrix algorithm){
    int row,pix,bit,span,firstRow,lastRow, myRank, threadCount, localChunk; 
...
#	pragma omp parallel num_threads(threadCount)
    ompConvolute(&srcImage,&destImage,algorithms[type]);
